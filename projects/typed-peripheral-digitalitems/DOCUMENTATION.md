...
The [Item Image Export](https://github.com/SchachSebastian/item-image-export)
tool targets NeoForge 1.21.1. Our tiny Fabric client exporter, shared with the
1.20 branch, instead calls vanilla `GuiGraphics.renderItem`; its screenshot
...
.gradle/nodejs/node-v22.14.0-linux-x64/bin/node --test \
  ...
  .github/scripts/docs-version-selector.test.mjs \
